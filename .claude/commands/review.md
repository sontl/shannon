---
description: Review code changes for Gandalf-specific patterns, security, and common mistakes
---

Review the current changes (staged or working directory) with focus on Gandalf-specific patterns and common mistakes.
...
## Step 2: Check Gandalf-Specific Patterns
