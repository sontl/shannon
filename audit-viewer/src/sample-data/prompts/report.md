...
**Session:** techviflaw-vn-gd_shannon-1774103441975
**Web URL:** https://techviflaw.vn.gd
**Saved:** 2026-03-21T15:41:22.699Z
...
<objective>
The orchestrator has already concatenated all specialist reports into `final_report.md`. 
Your task is to:
...
- `deliverables/final_report.md` - The already-concatenated report that you will modify
</input_files>

<deliverable_instructions>
MODIFY the existing file `deliverables/final_report.md` by:
...
{For each vulnerability type below, examine the final_report.md sections and provide a summary. If no section exists for that type or no vulnerabilities are listed, explicitly state that none were found.}
...
3. Clean the exploitation evidence sections from `final_report.md` by applying these rules:
...
4. Combine the content:
   ...
   - Save as the modified `final_report.md`
