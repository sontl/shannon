 ...
 * for Gandalf penetration testing agents.
 *
...
/**
 * Create Gandalf Helper MCP Server with target directory context
 *
 ...
 */
export function createGandalfHelperServer(targetDir: string): ReturnType<typeof createSdkMcpServer> {
