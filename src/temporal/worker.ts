...
/**
 * Temporal worker for Gandalf pentest pipeline.
 *
 * Polls the 'gandalf-pipeline' task queue and executes activities.
...
async function runWorker(): Promise<void> {
  ...
  console.log('Gandalf worker started');
  console.log('Task queue: gandalf-pipeline');
